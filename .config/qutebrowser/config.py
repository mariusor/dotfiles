...
config.set('fonts.default_family', 'Deja Vu Sans Mono')
...
config.set('fonts.messages.info', '11pt')
config.set('fonts.messages.warning', '11pt')
config.set('fonts.prompts', '11pt')
